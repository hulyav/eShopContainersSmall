namespace Microsoft.eShopOnContainers.Services.Buying.API.Infrastructure
{
    using AspNetCore.Builder;
    using global::Buying.API.Extensions;
    ...
    public class BuyingContextSeed
    {
        public  async Task SeedAsync(BuyingContext context, IHostingEnvironment env,IOptions<BuyingSettings> settings, ILogger<BuyingContextSeed> logger)
        {
            var policy = CreatePolicy(logger, nameof(BuyingContextSeed));
        ...
        private IEnumerable<CardType> GetCardTypesFromFile(string contentRootPath, ILogger<BuyingContextSeed> log)
        {
        ...
        /*
        private IEnumerable<OrderStatus> GetOrderStatusFromFile(string contentRootPath, ILogger<BuyingContextSeed> log)
        {
        ...
        */
        ...
        private Policy CreatePolicy( ILogger<BuyingContextSeed> logger, string prefix, int retries =3)
        {
